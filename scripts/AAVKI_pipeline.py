...
from AAVKI_align import run_align
from AAVKI_layered_filter import run_layered_filters
from AAVKI_OT_quantification import run_quantification
import re
import argparse
...
def main():
    ...
    # merged_reads = run_QC_and_merge(args.read1,args.read2,args.adaptors,args.trim_pars,args.barcode)
    # print("QC done.")
    ...
    # Layered filters
    OT_HDR_file,OT_NHEJ_file = run_layered_filters(samfile,int(args.homoarm),args.site)
    print("Filtering done.")

    # Quantification
    run_quantification(OT_HDR_file)
    run_quantification(OT_NHEJ_file)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-tp','--trim_pars',default="SLIDINGWINDOW:4:20 LEADING:5 TRAILING:5 MINLEN:100",\
        help="[Optional] Arguments and parameters for trimmomatic. \
        (DEFAULT = SLIDINGWINDOW:4:20 LEADING:5 TRAILING:5 MINLEN:100)")
